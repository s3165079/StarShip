...
// D. Locke
// 8/11/2023
// added duration of mission and time of departure using .plus()
...
public class Starship {
   ...
   public void addAstronaut(String name, 
      ...
      Period pDays = Period.ofDays(90);
      LocalDate ldDeparture = ldtArrival.plus(pDays).toLocalDate();
      
      astronauts.add(new Astronaut(name, heightCm, weightKg, ldtArrival, pDays, ldDeparture));
      this.weightKg += weightKg;
   }
